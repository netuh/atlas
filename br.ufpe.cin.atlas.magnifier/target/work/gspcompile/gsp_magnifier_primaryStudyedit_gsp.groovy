...
class gsp_magnifier_primaryStudyedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/primaryStudy/edit.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',27,['bean':(primaryStudyInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(primaryStudyInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(primaryStudyInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:primaryStudyInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
