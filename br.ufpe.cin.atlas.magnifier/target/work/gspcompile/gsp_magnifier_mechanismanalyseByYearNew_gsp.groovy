...
class gsp_magnifier_mechanismanalyseByYearNew_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mechanism/analyseByYearNew.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(13)
invokeTag('actionSubmit','g',51,['action':("analyseByYearNew"),'value':(message(code: 'default.button.update.label', default: 'Update'))],-1)
printHtmlPart(14)
})
...
public static final long LAST_MODIFIED = 1384879564000L
