...
class gsp_magnifier_mechanismindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mechanism/index.gsp" }
public Object run() {
Writer out = getOut()
...
loop:{
int i = 0
for( mechanismInstance in (mechanismInstanceList) ) {
printHtmlPart(15)
